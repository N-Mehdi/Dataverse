...
def main():
    ...
    pred_path = sys.argv[2] if len(sys.argv) > 2 else "output/model_comparison_with_logistic/test_predictions_long.csv"
    out_dir = Path(sys.argv[3]) if len(sys.argv) > 3 else Path("output/theta_analysis_logistic")
